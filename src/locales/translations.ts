...
export const translations = {
  ...
  es: {
    ...
    'calculator.personAPlaceholder': 'Ingresa los ingresos de la Persona A',
    'calculator.personBPlaceholder': 'Ingresa los ingresos de la Persona B',
    'calculator.billPlaceholder': 'Ingresa el monto total del gasto',
